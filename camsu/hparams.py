...
voc_model_id = 'khehue_raw'
tts_model_id = 'khehue_lsa_smooth_attention'
...
voc_target = 4_000                  # target number of samples to be generated in each batch entry
...
tts_schedule = [(17, 1e-3,   2_500,  32),   # progressive training schedule
                (12, 1e-3,   5_000,  32),   # (r, lr, step, batch_size)
                (7,  1e-3,  10_000,  32),
                (5,  1e-4, 100_000,  32),
                (2,  1e-4, 180_000,  16),
                (2,  1e-4, 350_000,  8)]
